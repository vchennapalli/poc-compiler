...
//		show(program);  //It may be useful  to show this here if code generation fails
	...
	public void integerLit() throws Exception {
		...
		//String input = prog + "{image y; input y from @ 0 ; show y;sleep(5000);}";
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {"/Users/vineethchennapalli/Desktop/image.jpg"}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
